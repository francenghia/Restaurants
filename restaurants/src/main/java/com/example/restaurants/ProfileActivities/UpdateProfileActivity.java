...
public class UpdateProfileActivity extends AppCompatActivity {
    ...
    private static final String API_KEY_GG_MAP = "AIzaSyAD5zLkUN7GmyQlIotnaWlk706jCr1gEKU";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Places.
        Places.initialize(getApplicationContext(), API_KEY_GG_MAP);
    ...
    private void editPhoto(){
        AlertDialog alertDialog = new AlertDialog.Builder(UpdateProfileActivity.this, R.style.AlertDialogStyle).create();
        LayoutInflater factory = LayoutInflater.from(UpdateProfileActivity.this);
    ...
    private void setOpeningTimeDialog(){
        ...
        LayoutInflater inflater = LayoutInflater.from(UpdateProfileActivity.this);
