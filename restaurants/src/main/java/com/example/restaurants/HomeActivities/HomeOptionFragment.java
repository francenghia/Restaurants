...
import static com.example.common.Utilities.getDateFromTimestamp;
...
public class HomeOptionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_home_option, container, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            case R.id.favourite_dishes:
                if(HomeOptionFragment.this.isVisible())
