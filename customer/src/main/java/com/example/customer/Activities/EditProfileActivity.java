...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Places.
        Places.initialize(getApplicationContext(), "AIzaSyAD5zLkUN7GmyQlIotnaWlk706jCr1gEKU");
    ...
    private void editPhoto(){
        AlertDialog alertDialog = new AlertDialog.Builder(EditProfileActivity.this, R.style.AppTheme_AlertDialogStyle).create();
        LayoutInflater factory = LayoutInflater.from(EditProfileActivity.this);
