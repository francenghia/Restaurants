...
import com.example.customer.ViewHolders.DailyOfferViewHolder;
...
public class OrderingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new FirebaseRecyclerAdapter<DishItem, DailyOfferViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull DailyOfferViewHolder holder, int i, @NonNull DishItem dishItem) {
                holder.setData(dishItem, i);
