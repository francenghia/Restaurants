...
import static com.example.common.Shared.CameraOpen;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void editPhoto(){
        AlertDialog alertDialog = new AlertDialog.Builder(SignUpActivity.this, R.style.AppTheme_AlertDialogStyle).create();
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "com.example.customer.fileprovider",
                        photoFile);
