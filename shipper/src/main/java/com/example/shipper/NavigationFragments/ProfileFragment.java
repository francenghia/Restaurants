...
import com.example.shipper.Activities.MainActivity;
import com.example.shipper.ProfileManagment.EditPasswordActivity;
import com.example.shipper.ProfileManagment.EditProfileActivity;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference myRef = database.getReference(SHIPPERS_PATH).child(ROOT_UID);
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                User user;
                user = dataSnapshot.child("shipper_info").getValue(User.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.edit_password:
                Intent editPsw = new Intent(getContext(), EditPasswordActivity.class);
