...
public class EditProfileActivity extends AppCompatActivity {
            ...
            ref.putFile(imageUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()){
                        ...
                        DatabaseReference myRef = database.getReference(SHIPPER_INFO +"/"+UID);
    ...
    private void editPhoto(){
        AlertDialog alertDialog = new AlertDialog.Builder(EditProfileActivity.this, R.style.AlertDialogStyle).create();
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "com.example.shipper.fileprovider",
                        photoFile);
